          ...
          return Scaffold(
            appBar: AppBar(
              actions: [
                TextButton(
                    onPressed: () {
                      cub.createPost(text: textCo.text).then((value){
                          Navigator.pop(context);
                    ...
                    Expanded(
                      child: GestureDetector(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                          Icon(IconlyBroken.image,size: 30,color: cub.isDark ? defaultBlueColor : Colors.black,),
                          const SizedBox(width: 10,),
                          Text('Add Photo',style: TextStyle(fontSize: 18,color: defaultBlueColor ),),
                        ],),
                      ),
                    ),
                    Expanded(child: Center(child: TextButton(onPressed: (){},child: const Text('# Tags' , style: TextStyle(color: Colors.purple),),)))
                  ],)
                ],
              ),
            ),
